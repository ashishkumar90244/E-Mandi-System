        ...
        function(req, username, password, done) {
            ...
            connection.query("SELECT * FROM users WHERE username = ?",[username], function(err, rows) {
                ...
                if (rows.length) {
                    ...
                    var insertQuery = "INSERT INTO users ( username, password,role,state,email ) values (?,?,?,?,?)";

                    connection.query(insertQuery,[newUserMysql.username, newUserMysql.password, newUserMysql.role, newUserMysql.state,newUserMysql.email],function(err, rows) {
